...
difference() {
	union() {
		translate(v = [-63.0000000000, -105.0000000000, 0]) {
			cube(size = [129, 210, 1.5000000000]);
		}
		translate(v = [-63.0000000000, 103.0000000000, 0]) {
			cube(size = [129, 2, 90]);
		}
		translate(v = [64.0000000000, -105.0000000000, 0]) {
			cube(size = [2, 210, 90]);
		}
		translate(v = [-63.0000000000, -105.0000000000, 0]) {
			cube(size = [2, 210, 90]);
		}
		#translate(v = [-42.0000000000, -84.0000000000, -4.6000000000]) {
		...
		#translate(v = [0.0000000000, -84.0000000000, -4.6000000000]) {
			gridfinity_base_tile_raw(distancex = 0, distancey = 0, fitx = 0, fity = 0);
		}
